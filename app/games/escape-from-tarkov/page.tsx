      ...
      <section className="w-full min-h-screen flex flex-col items-center justify-center px-4 py-24 bg-gradient-to-b from-background to-accent/10">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold">
            ...
            <span className="text-primary">Escape from Tarkov</span>
          </h1>
          <p className="text-xl text-foreground/80">
            Zero RAM impact, no ban risk, and perfect for raids and PvP. Works with all EFT patches.
          </p>
      ...
      <section className="w-full py-24 px-4 bg-background">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <h3 className="text-xl font-semibold mb-4">Zero Performance Impact</h3>
              <p className="text-foreground/80">
                Our overlay uses minimal system resources, ensuring your Tarkov gameplay stays smooth and lag-free.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            >
              ...
              <p className="text-foreground/80">
                Run ChrossX alongside Tarkov. Works with any game mode or map.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-foreground/80">
                Choose your preferred crosshair style, color, and size for the perfect setup.
              </p>
            </motion.div>
          </div>
