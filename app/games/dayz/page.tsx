      ...
      <section className="w-full min-h-screen flex flex-col items-center justify-center px-4 py-24 bg-gradient-to-b from-background to-accent/10">
        ...
        >
          ...
          <p className="text-xl text-foreground/80">
            Zero RAM impact, no ban risk, and perfect for PvP and survival. Works with all DayZ servers.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-foreground/80">
                Our overlay uses minimal system resources, ensuring your DayZ gameplay stays smooth and lag-free.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            >
              ...
              <p className="text-foreground/80">
                Run ChrossX alongside DayZ. Works with any server or game mode.
              </p>
            </motion.div>
